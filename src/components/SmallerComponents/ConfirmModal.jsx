            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-900 p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4 flex justify-end gap-3">
                  <button
                    type="button"
                    className="inline-flex justify-center rounded-md border border-transparent bg-gray-300 dark:bg-gray-700 px-4 py-2 text-sm font-medium text-black dark:text-white hover:bg-gray-400 dark:hover:bg-gray-600 focus:outline-none"
                    onClick={onClose}
                  >
                    Cancel
                  </button>
